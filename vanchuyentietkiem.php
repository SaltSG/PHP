...
<?php endif; ?>
    ...
    <div class="define mt-md-5 mt-3 position-relative container">
        <div class="row px-0 bg-define mx-auto">
            <div class="col-md-1 bg-mb-define"></div>
            <div class="col-md-6 d-flex align-items-center">
                <div class="row yellow-box-1 mar-right">
                    <h2 class="text-left">Vận chuyển tiết kiệm là gì?</h2>
                    <p>
                        Giao Tiết Kiệm là dịch vụ giao hàng với mức chi phí thấp và thời gian giao phù hợp với nhu cầu của khách hàng.
                    </p>
                    <a href="taovandon.html" class="btn px-0">Tạo vận đơn</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-4 number-one d-flex justify-content-center align-items-center mb-md-0 mb-5">
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <p>Cước phí vận chuyển rẻ; số lượng càng lớn, giá càng tiết kiệm.</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 number-two d-flex justify-content-center align-items-center mb-5 mb-md-0">
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <p>Thời gian chuyển phát từ 24h - 72h trên toàn quốc.</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 number-three d-flex justify-content-center align-items-center">
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <p>Đảm bảo các sản phẩm đến tay người nhận an toàn tuyệt đối.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container delivery_images my-md-5 my-3">
        <div class="row no-gutters justify-content-center">
            <div class="col-12 col-md-10 d-flex justify-content-center align-items-center flex-wrap">
                <div class="img-container col-6 col-md-4 p-2">
                    <img class="img-fluid lazyload" src="image/5.1.png" alt="Dịch vụ giao nhanh" data-original="4.1.png">
                </div>
                <div class="img-container col-6 col-md-4 p-2">
                    <img class="img-fluid lazyload" src="image/4.3.png" alt="Dịch vụ vận chuyển" data-original="4.3.png">
                </div>
                <div class="img-container col-6 col-md-4 p-2">
                    <img class="img-fluid lazyload" src="image/5.2.png" alt="Tra cứu chuyển phát nhanh" data-original="4.3.png">
                </div>
            </div>
        </div>
    </div>
