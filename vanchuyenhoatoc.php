        ...
        <div class="row px-0 bg-define mx-auto">
            ...
            <div class="col-md-6 d-flex align-items-center">
                <div class="row yellow-box-1 mar-right">
                    <h2 class="text-left">Vận chuyển hỏa tốc  là gì?</h2>
                    <p>
                        Giao Hẹn Giờ là dịch vụ giao hàng theo đúng thời gian mà khách hàng mong muốn.
                    </p>
        ...
        <div class="row">
            <div class="col-12 col-md-4 number-one d-flex justify-content-center align-items-center mb-md-0 mb-5">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h3>Chủ động khi giao hàng </h3>
                        <p>Tư vấn giao nhận linh hoạt thời gian đến lấy và giao hàng.</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 number-two d-flex justify-content-center align-items-center mb-5 mb-md-0">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h3>Tiện lợi khi nhận hàng</h3>
                        <p>Khách hàng an tâm nhận hàng theo khung giờ hợp lý.</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 number-three d-flex justify-content-center align-items-center">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h3>Không mất thời gian chờ đợi</h3>
                        <p>Tiết kiệm tối đa thời gian gửi/nhận hàng cho cả khách hàng và shipper.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row no-gutters justify-content-center">
            <div class="col-12 col-md-8 d-flex justify-content-center align-items-center flex-wrap">
                <div class="img-container col-6 col-md-3 p-2">
                    <img class="img-fluid lazyload" src="image/4.1.png" alt="Dịch vụ giao nhanh" data-original="4.1.png">
                </div>
                <div class="img-container col-6 col-md-3 p-2">
                    <img class="img-fluid lazyload" src="image/5.2.png" alt="Dịch vụ vận chuyển" data-original="4.2.png">
                </div>
                <div class="img-container col-6 col-md-3 p-2">
                    <img class="img-fluid lazyload" src="image/4.3.png" alt="Tra cứu chuyển phát nhanh" data-original="4.3.png">
                </div>
                <div class="img-container col-6 col-md-3 p-2">
                    <img class="img-fluid lazyload" src="image/5.1.png" alt="Giao hàng nhanh giá rẻ" data-original="4.4.png">
                </div>
            </div>
        </div>
    </div>
